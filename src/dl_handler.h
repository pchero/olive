...
json_t* dl_create(json_t* j_dl, const char* id);
json_t* dl_get_info(const char* uuid);
json_t* dl_update_info(const char* dlma_uuid, const json_t* j_recv, const char* agent_id);
json_t* dl_delete(const char* dlma_uuid, const char* agent_id);
