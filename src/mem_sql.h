...
char* SQL_CREATE_DIALING = "create table dialing(\n"
        ...
        "dlma_uuid      text,   -- dl list master uuid\n"
        "camp_uuid      text,   -- campaign uuid\n"

        "-- dial json info.\n"
        "info_camp  text,   -- campaign info. json format.\n"
        "info_plan  text,   -- plan info. json format.\n"
        "info_dl    text,   -- dl info. json format.\n"

        "-- status\n"
        "status     text,        -- dialing status. [dialing, transferring, transferred, hangup, finished, ...]\n"
        "tr_status  text,        -- dialing status. [dialing, transferring, transferred, hangup, finished, ...]\n"
        ...
        "tm_bridge          text,   -- timestamp for channel bridged.\n"
        "tm_hangup          text,   -- customer hangup timestamp.\n"
        "tm_tr_dial         text,   -- dialed to agent timestamp.\n"
        "tm_tr_dial_end     text,   -- transfer to agent timestamp.\n"
        "tm_tr_hangup       text,   -- agent hangup timestamp.\n"

        "-- dial info.\n"
        "dial_index     int,    -- dialing number index.\n"
        "dial_addr      text,   -- dialing address.\n"
        ...
        "res_hangup             text,   -- hangup code.\n"
        "res_hangup_detail      text,   -- hangup detail.\n"
        "res_tr_dial            text,   -- dial result(answer, no_answer, ...)\n"
        "res_tr_hangup          text,   -- hangup code.\n"
        "res_tr_hangup_detail   text,   -- hangup detail.\n"
...
char* SQL_CREATE_COMMAND = "create table command(\n"
        ...
        "tm_cmd_start   text,   -- timestamp. cmd work start.\n"
        "tm_cmd_end     text,   -- timestamp. cmd work end.\n"

        "-- command\n"
        "cmd        text,   -- cmd\n"
        "cmd_param  text,   -- cmd parameters. json format.\n"
