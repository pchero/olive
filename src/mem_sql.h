...
//        "agent_transfer  text,  -- transfered agent uuid\n"
        ...
        "RTPAUDIOQOS text,  -- RTPAUDIOQOS\n"
        "RTPAUDIOQOSRTT text,   -- RTPAUDIOQOSRTT\n"
        "RTPAUDIOQOSLOSS text,  -- RTPAUDIOQOSLOSS\n"
        "RTPAUDIOQOSJITTER text,    -- RTPAUDIOQOSJITTER\n"

        "PARKING_SPACE text,    -- PARKING_SPACE\n"
        "PARKINGSLOT text,      -- PARKINGSLOT\n"
        "PARKEDLOT text,        -- PARKEDLOT\n"
        "PARKER text,           -- PARKER\n"
        "PARKER_FLAT text,      -- PARKER_FLAT\n"
        "BRIDGE_FEATURES text,  -- BRIDGE_FEATURES\n"
